...
template<class ActionC, class StateC, class DistributionC, class AgentOutputC>
class GradientBlackBoxAlgorithm : public BlackBoxAlgorithm<ActionC, StateC, DistributionC, AgentOutputC>
{
public:
    GradientBlackBoxAlgorithm(DistributionC& dist, ParametricPolicy<ActionC, StateC>& policy,
                              unsigned int nbEpisodes, unsigned int nbPolicies,
                              double step_length, bool baseline = true, int reward_obj = 0)
        : BlackBoxAlgorithm<ActionC, StateC, DistributionC, AgentOutputC>(dist,policy,nbEpisodes,nbPolicies, baseline, reward_obj),
