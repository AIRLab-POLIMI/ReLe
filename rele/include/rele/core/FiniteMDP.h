 ...
 * \f$MDP=\left\langle \mathcal{X},\mathcal{U},\mathcal{P}_{u}(.,..),\mathcal{R}_{u}(.,.),\gamma\right\rangle\f$
 * where \f$\mathcal{X}\f$ is the set of states, \f$\mathcal{U}\f$ is the set of actions,
 * \f$\mathcal{P}_{u}:\mathcal{U}\times\mathcal{X}\times\mathcal{X}\rightarrow\mathbb{R}\f$ is the transition function,
 * \f$\mathcal{R}_{u}:\mathcal{U}\times\mathcal{X}\times\mathcal{X}\rightarrow\mathbb{R}\f$ is the reward function.
...
public:
    /*!
     * Constructor
     * \param P the transition function, a \f$\mathcal{U}\times\mathcal{X}\times\mathcal{X}\f$ cube
     * \param R the reward function a \f$\mathcal{U}\times\mathcal{X}\times\mathcal{X}\f$ cube
     * \param Rsigma the reward function variance in each state a \f$\mathcal{U}\times\mathcal{X}\times\mathcal{X}\f$ cube
