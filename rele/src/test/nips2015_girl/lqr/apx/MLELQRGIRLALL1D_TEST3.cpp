...
void help()
{
    cout << "lqr_GIRLNIPS_TEST3 seed episodes 2 reward1 reward2" << endl;
}
...
//        RandomGenerator::seed(4434224);
    ...
    IdentityBasis* pfn = new IdentityBasis(0);
    DenseFeatures phin(pfn);
    ...
    timerFileMLE << timerMLE.format(10, "%w") << std::endl;
    timerFileMLE.close();
